...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    default-src 'self';
    script-src 'self' 'nonce-${nonce}' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.youtube.com https://youtube.com https://s.ytimg.com https://www.markaba.news https://cdn.onesignal.com https://onesignal.com https://api.onesignal.com https://static.cloudflareinsights.com ${isDev ? "'unsafe-eval'" : ''};
    script-src-elem 'self' 'nonce-${nonce}' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.youtube.com https://youtube.com https://s.ytimg.com https://www.markaba.news https://cdn.onesignal.com https://onesignal.com https://api.onesignal.com https://static.cloudflareinsights.com ${isDev ? "'unsafe-eval'" : ''};
